...
public class CoffeeController {
     ...
     * <b>Solution 키 포인트</b>
     * <ul>
     *     <li>@RequestParam을 이용해 각각의 파라미터를 전달 받는 대신에 DTO 클래스를 이용해 한번에 전달 받는다.</li>
     * </ul>
     ...
     *          <p>
     *          서비스 계층과의 연동이 없으므로 편의상 request body로 전달받은 coffeePostDto를 그대로 되돌려 준다.
     */
    @PostMapping
     ...
     *
     * @return 클라이언트 측에 전송하는 response body용 커피 정보가 포함된 ResponseEntity.
     *         서비스 계층과의 연동이 없으므로 편의상 request body로 전달받은 coffeePatchDto를 그대로 되돌려 준다.
     *
     */
