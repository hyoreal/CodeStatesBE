...
public class HelloUserAuthenticationProvider implements AuthenticationProvider {
    ...
    public HelloUserAuthenticationProvider(MemberService memberService, HelloAuthorityUtils authorityUtils) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        Optional.ofNullable(email).orElseThrow(() -> new UsernameNotFoundException("Invalid User name or User Password"));
