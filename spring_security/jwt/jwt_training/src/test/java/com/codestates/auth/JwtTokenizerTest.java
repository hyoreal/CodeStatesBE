...
// @TestInstance 테스트 인스턴스의 라이프 사이클 설정 시 사용
// PER_METHOD : 테스트 함수 당 인스턴스 생성
// PER_CLASS : 테스트 클래스 당 인스턴스 생성
...
public class JwtTokenizerTest {
    ...
    // (1) 테스트에 사용할 Secret Key를 Base64 형식으로 인코딩 한 후, 인코딩 된 Secret Key를 각 테스트 케이스에서 사용
    @BeforeAll
    public void init() {
        jwtTokenizer = new JwtTokenizer();
        secretKey = "hyoreal12341234123412341234123412341234";
